...
export default function ProfilePage() {
 ...
 const [sidebarOpen, setSidebarOpen] = useState(false);
  ...
  return (
    <div className="flex min-h-screen bg-muted/40 mt-25 overflow-hidden relative">
      {/* MOBILE BURGER */}
      <Button
        onClick={() => setSidebarOpen(true)}
        className="md:hidden fixed top-31.5 left-4 z-50"
        variant="outline"
      >
        ☰
      </Button>
      ...
      <div
        className={`
          fixed top-25 left-0 z-50 overflow-y-hidden
      ...
      {/* CONTENT */}
      <div className="flex-1 md:ml-[260px] h-full overflow-y-auto">
        <div className="p-6 lg:w-[1000px] mx-auto">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold pl-18 md:pl-0">Kitoblar</h1>
          ...
          {loading && !materials.length ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {materials.map((item) => (
                ...
                >
                  <CardContent className="p-4 flex flex-col gap-y-1 pb-12">
                    <img
